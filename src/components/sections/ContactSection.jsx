    ...
    <section className="py-20 relative">
      <div className="flex items-center mb-12">
        <h2 className="text-3xl md:text-4xl font-mono font-bold flex items-center">
          ...
          contact_me
          {retroEffects && (
            <span className="terminal-cursor ml-2 text-royal-blue-500">
              _
            </span>
          )}
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-royal-blue-500/10 rounded-lg flex items-center justify-center">
                <svg
                  className="w-5 h-5 text-royal-blue-500"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div>
                ...
                <a
                  href={`mailto:${email}`}
                  className="font-mono hover:text-royal-blue-500 transition-colors"
                >
                  {email}
                </a>
              </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {serverError && (
              <div className="p-3 text-sm border border-red-500 text-red-500 rounded-lg font-mono">
                {serverError}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={isSending}
              className="w-full px-6 py-4 bg-royal-blue-500 text-white rounded-lg font-mono hover:bg-royal-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-royal-blue-500 focus:ring-offset-2 disabled:opacity-60"
            >
